...
const ResetPasswordModal: React.FC<ResetPasswordModalProps> = ({ 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simulate API call
    try {
      // Here you would make your actual API call to reset the password
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={<>Reset Your <span className="highlight">Password</span></>}
    >
      {isSuccess ? (
        <div className="text-center space-y-6">
          ...
          <p className="text-white/80 normal-text">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label htmlFor="new-password" className="block text-sm font-medium text-white mb-2 normal-text">
              New Password
            </label>
            ...
            {errors.password && (
              <p className="mt-2 text-sm text-red-400 normal-text">{errors.password}</p>
            )}
            <ul className="mt-2 text-sm text-white/60 space-y-1 normal-text">
          ...
          <div>
            ...
            {errors.confirmPassword && (
              <p className="mt-2 text-sm text-red-400 normal-text">{errors.confirmPassword}</p>
            )}
          </div>
